    ...
    function bn() {
      if (
        ...
        T.insertAdjacentHTML(
          "afterbegin",
          '<div className="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span className="current">' +
            Hn() +
            "</span>  of " +
            Q +
            "</div>"
      ...
      oe &&
        (xe ||
          ...
          (T.insertAdjacentHTML(
            ...
            '<div className="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' +
              Yt +
              '">' +
              pt[0] +
